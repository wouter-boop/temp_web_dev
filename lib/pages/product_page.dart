      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            BlockContainer(child: WebsiteFooter(), screenWidthFactor: 1, hasHorizontalPadding: false, padding: EdgeInsetsGeometry.only(bottom: 0),)
          ],
        ),
      ),
    );
...
class SmallInfoBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      spacing: 64,
      children: [
        isLeft ? Image.asset(imagePath) : Container(),
        Container(
          width: 340,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
        ...
        isLeft ? Container() : Image.asset(imagePath),
      ],
    );
  }
}
