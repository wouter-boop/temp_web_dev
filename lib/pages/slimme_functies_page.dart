            ...
            BlockContainer(
              child: Column(
                children: [
                  const Text(
                    "Slimme functies",
                    style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: Color(0xFF0F382C)),
                  ),
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    children: [
                      const Text(
                        "Meer slimme fucties",
                        style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Color(0xFF0F3B3F)),
                      ),
                      const SizedBox(height: 32),
