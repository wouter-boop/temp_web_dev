...
class FeatureList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlockContainer(
      // The section above (cloud/lokaal comparison) is white; feather into it.
      softTopEdge: Colors.white,
              ...
              child: ContentContainer(
                child: Column(
                  ...
                  children: [
                    ...
                    // Each feature slides in from an alternating side as it
                    // scrolls into view.
                    RevealOnScroll(
                      offset: isMobile ? const Offset(0, 32) : const Offset(-40, 0),
